...
class KitHelper {
    public static function generate($event, $user) {
        ...
        $addBorder = function($pdf) {
            ...
            $pdf->SetDrawColor(160, 160, 160); // Soft customizable gray
            $pdf->Rect(10, 10, 190, 277); // Outer border
            $pdf->SetLineWidth(0.2);
            $pdf->Rect(12, 12, 186, 273); // Inner border
        };
        ...
        // QR Code Placeholders (Simulated)
        $pdf->SetY(160);
        ...
        // PAGES 3-11: THE 9 EVENT KIT ITEMS
        $kitItems = [
            [
                'title' => 'Step-by-Step Event Guide',
                'type' => 'text',
            ...
            [
                ...
                'type' => 'text',
                'description' => "Share the experience. Invite your loved ones to join the community.",
